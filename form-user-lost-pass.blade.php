...
<form method="post"
    ...
    <fieldset class="bbp-form">
        <legend>@php esc_html_e( 'Lost Password', 'bbpress' ); @endphp</legend>

        <div class="bbp-username">
            <p>
                <label for="user_login" class="hide">@php esc_html_e( 'Username or Email', 'bbpress' ); @endphp
                    : </label>
        ...
        <div class="bbp-submit-wrapper">
            ...
            <button type="submit" name="user-submit"
                    class="button submit user-submit">@php esc_html_e( 'Reset My Password', 'bbpress' ); @endphp</button>
