                    ...
                    <fieldset class="bbp-form">
                        ...
                        @if ( ! bbp_is_topic_edit() && bbp_is_forum_closed() )
                            ...
                            <div class="bbp-template-notice">
                                <ul>
                                    <li>@php esc_html_e( 'This forum is marked as closed to new topics, however your posting capabilities still allow you to create a topic.', 'bbpress' ); @endphp</li>
                                </ul>
                            </div>
                        ...
                        <div>
                            ...
                            <p>
                                <label for="bbp_topic_title">@php printf( esc_html__( 'Topic Title (Maximum Length: %d):', 'bbpress' ), bbp_get_title_max_length() ); @endphp</label><br/>
                            ...
                            @if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags', bbp_get_topic_id() ) )
                                ...
                                <p>
                                    <label for="bbp_topic_tags">@php esc_html_e( 'Topic Tags:', 'bbpress' ); @endphp</label><br/>
                            ...
                            @if ( ! bbp_is_single_forum() )
                                ...
                                <p>
                                    <label for="bbp_forum_id">@php esc_html_e( 'Forum:', 'bbpress' ); @endphp</label><br/>
                                    @php
                                        bbp_dropdown( array(
                            ...
                            @if ( current_user_can( 'moderate', bbp_get_topic_id() ) )
                                ...
                                <p>
                                    ...
                                    <label for="bbp_stick_topic">@php esc_html_e( 'Topic Type:', 'bbpress' ); @endphp</label><br/>
                                ...
                                <p>
                                    ...
                                    <label for="bbp_topic_status">@php esc_html_e( 'Topic Status:', 'bbpress' ); @endphp</label><br/>
                            ...
                            @if ( bbp_allow_revisions() && bbp_is_topic_edit() )
                                ...
                                <fieldset class="bbp-form">
                                    ...
                                    <div>
                                        <label for="bbp_topic_edit_reason">@php printf( esc_html__( 'Optional reason for editing:', 'bbpress' ), bbp_get_current_user_name() ); @endphp</label><br/>
