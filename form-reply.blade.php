            ...
            <div id="new-reply-{{ bbp_topic_id() }}" class="bbp-reply-form">
                ...
                <form id="new-post" name="new-post" method="post">
                    ...
                    <fieldset class="bbp-form">
                        <legend>@php printf( esc_html__( 'Reply To: %s', 'bbpress' ), ( bbp_get_form_reply_to() ) ? sprintf( esc_html__( 'Reply #%1$s in %2$s', 'bbpress' ), bbp_get_form_reply_to(), bbp_get_topic_title() ) : bbp_get_topic_title() ); @endphp</legend>
                        ...
                        <div>
                            ...
                            @if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags', bbp_get_topic_id() ) )
                                ...
                                <p>
                                    <label for="bbp_topic_tags">@php esc_html_e( 'Tags:', 'bbpress' ); @endphp</label><br/>
                            ...
                            @if ( bbp_is_reply_edit() )
                                ...
                                @if ( current_user_can( 'moderate', bbp_get_reply_id() ) )
                                    ...
                                    <p class="form-reply-to">
                                        <label for="bbp_reply_to">@php esc_html_e( 'Reply To:', 'bbpress' ); @endphp</label><br/>
                                    ...
                                    <p>
                                        <label for="bbp_reply_status">@php esc_html_e( 'Reply Status:', 'bbpress' ); @endphp</label><br/>
                                    ...
                                    <fieldset class="bbp-form">
                                        <legend>
                                            <input name="bbp_log_reply_edit" id="bbp_log_reply_edit" type="checkbox"
                                                   value="1" @php bbp_form_reply_log_edit(); @endphp />
                                            <label for="bbp_log_reply_edit">@php esc_html_e( 'Keep a log of this edit:', 'bbpress' ); @endphp</label><br/>
                                        </legend>

                                        <div>
                                            <label for="bbp_reply_edit_reason">@php printf( esc_html__( 'Optional reason for editing:', 'bbpress' ), bbp_get_current_user_name() ); @endphp</label><br/>
