        ...
        <div id="move-reply-{{ bbp_topic_id() }}" class="bbp-reply-move">
            ...
            <form id="move_reply" name="move_reply" method="post">
                ...
                <fieldset class="bbp-form">
                    ...
                    <legend>@php printf( esc_html__( 'Move reply "%s"', 'bbpress' ), bbp_get_reply_title() ); @endphp</legend>

                    <div>

                        <div class="bbp-template-notice info">
                            <ul>
                                <li>@php esc_html_e( 'You can either make this reply a new topic with a new title, or merge it into an existing topic.', 'bbpress' ); @endphp</li>
                            </ul>
                        </div>

                        <div class="bbp-template-notice">
                            <ul>
                                <li>@php esc_html_e( 'If you choose an existing topic, replies will be ordered by the time and date they were created.', 'bbpress' ); @endphp</li>
                            </ul>
                        </div>

                        <fieldset class="bbp-form">
                            <legend>@php esc_html_e( 'Move Method', 'bbpress' ); @endphp</legend>
