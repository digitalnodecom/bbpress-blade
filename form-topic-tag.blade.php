...
@if ( current_user_can( 'edit_topic_tags' ) )
    ...
    <div id="edit-topic-tag-@php bbp_topic_tag_id(); @endphp" class="bbp-topic-tag-form">

        <fieldset class="bbp-form" id="bbp-edit-topic-tag">

            <legend>@php printf( esc_html__( 'Manage Tag: "%s"', 'bbpress' ), bbp_get_topic_tag_name() ); @endphp</legend>

            <fieldset class="bbp-form" id="tag-rename">

                <legend>@php esc_html_e( 'Rename', 'bbpress' ); @endphp</legend>

                <div class="bbp-template-notice info">
                    <ul>
                        <li>@php esc_html_e( 'Leave the slug empty to have one automatically generated.', 'bbpress' ); @endphp</li>
                    </ul>
                </div>

                <div class="bbp-template-notice">
                    <ul>
                        <li>@php esc_html_e( 'Changing the slug affects its permalink. Any links to the old slug will stop working.', 'bbpress' ); @endphp</li>
                    </ul>
                </div>
                ...
                <form id="rename_tag" name="rename_tag" method="post">
                    ...
                    <div>
                        <label for="tag-name">@php esc_html_e( 'Name:', 'bbpress' ); @endphp</label>
                        <input type="text" id="tag-name" name="tag-name" size="20" maxlength="40"
                               value="{!! esc_attr( bbp_get_topic_tag_name() ) !!}"/>
                    </div>

                    <div>
                        <label for="tag-slug">@php esc_html_e( 'Slug:', 'bbpress' ); @endphp</label>
                    ...
                    <div>
                        <label for="tag-description">@php esc_html_e( 'Description:', 'bbpress' ); @endphp</label>
                    ...
                    <div class="bbp-submit-wrapper">
                        <button type="submit"
                                class="button submit">@php esc_attr_e( 'Update', 'bbpress' ); @endphp</button>
            ...
            <fieldset class="bbp-form" id="tag-merge">
                ...
                <legend>@php esc_html_e( 'Merge', 'bbpress' ); @endphp</legend>

                <div class="bbp-template-notice">
                    <ul>
                        <li>@php esc_html_e( 'Merging tags together cannot be undone.', 'bbpress' ); @endphp</li>
                    </ul>
                </div>
                ...
                <form id="merge_tag" name="merge_tag" method="post">
                    ...
                    <div>
                        <label for="tag-existing-name">@php esc_html_e( 'Existing tag:', 'bbpress' ); @endphp</label>
            ...
            @if ( current_user_can( 'delete_topic_tags' ) )
                ...
                <fieldset class="bbp-form" id="delete-tag">
                    ...
                    <legend>@php esc_html_e( 'Delete', 'bbpress' ); @endphp</legend>

                    <div class="bbp-template-notice info">
                        <ul>
                            <li>@php esc_html_e( 'This does not delete your topics. Only the tag itself is deleted.', 'bbpress' ); @endphp</li>
                        </ul>
                    </div>
                    <div class="bbp-template-notice">
                        <ul>
                            <li>@php esc_html_e( 'Deleting a tag cannot be undone.', 'bbpress' ); @endphp</li>
                            <li>@php esc_html_e( 'Any links to this tag will no longer function.', 'bbpress' ); @endphp</li>
                        </ul>
                    </div>
